...
public class SigUtils {
     ...
     * @throws java.security.cert.CertificateParsingException 
     */
    public static boolean checkTimeStampCertificateUsage(X509Certificate x509Certificate)
            throws CertificateParsingException
    {
        List<String> extendedKeyUsage = x509Certificate.getExtendedKeyUsage();
    ...
    public static void validateTimestampToken(TimeStampToken timeStampToken, X509Certificate cert) throws OperatorCreationException, IOException, TSPValidationException, TSPException
...
//                timeStampToken.getCertificates().getMatches((Selector<X509CertificateHolder>) timeStampToken.getSID());
//       
//        System.out.println("tstMatches:"+tstMatches);
//        X509CertificateHolder certificateHolder = tstMatches.iterator().next();
//        System.out.println("certificateHolder:"+certificateHolder);
        SignerInformationVerifier siv = 
                new JcaSimpleSignerInfoVerifierBuilder().setProvider(SecurityProvider.getProvider()).build(cert);
